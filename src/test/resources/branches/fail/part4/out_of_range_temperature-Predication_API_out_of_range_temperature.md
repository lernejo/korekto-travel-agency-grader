...
* Part 5 - Prediction API: 1/2
    * GET `/api/temperature?country=Botswana` should respond with temperatures generated from the given `countriesTempData.csv` file, however got a temperature of `666.0` for **Botswana** whereas it should be between `19.0` and `23.0`
